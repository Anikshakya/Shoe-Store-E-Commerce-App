...
class OrderHistoryTile extends StatefulWidget {
  final productName, image, productId;
  const OrderHistoryTile({Key? key, this.productName, this.image, this.productId}) : super(key: key);
  ...
  addReview(){
    ...
    try {
      ...
      Map<String, dynamic> data = {
        'comment': reviewController.text.trim().toString(),
        'name': user.email.toString(),
        'timestamp': DateTime.now().toString(),
      };
      documentReferencer.set(data).then((value) => Navigator.pop(context)).then(
          (value) => Get.snackbar("Review Added", "Thanks for your review!",
